...
function vlog_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Preset Styles', 'vlog' ),
            //'description' => __( 'This is a section for the typography', 'vlog' ),
            'priority' => 20,
        )
    );
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Header Banner Background Color', 'vlog' ),
    ...
    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize','vlog' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Banner Tagline', 'vlog' ),
        'section'    => 'header_image',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
        ...
        'label'    => __('Remove Header Banner', 'vlog'),
        'section'    => 'header_image',
        'type'     => 'checkbox',
    ) ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Other Customizations', 'vlog' ),
            //'description' => __( 'This is a section for the header banner Image.', 'vlog' ),
            'priority' => 40,
        )
    );
    $wp_customize->add_section(
        'colors',
        array(
            'title' => __( 'Background Color', 'vlog' ),
            //'description' => __( 'This is a section for the header banner Image.', 'vlog' ),
            'priority' => 50,
    ...
    $wp_customize->add_section(
        'background_image',
        array(
            'title' => __( 'Background Image', 'vlog' ),
            //'description' => __( 'This is a section for the header banner Image.', 'vlog' ),
            'priority' => 60,
            'panel' => 'styling_option_panel',
        )
    ...
    $wp_customize->add_control( 
        'cdn_assets',
        array(
            'label' => __( 'Use CDN for Assets', 'vlog' ),
            'description' => __( 'All Bootstrap Assets and FontAwesome will be loaded in CDN.', 'vlog' ),
    ...
    $wp_customize->add_setting( 'vlog_logo', array(
        //'default' => __( '', 'vlog' ),
        'sanitize_callback' => 'esc_url',
    ) );
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'vlog_logo', array(
        'label'    => __( 'Upload Logo (replaces text)', 'vlog' ),
...
add_action( 'wp_head', 'vlog_customizer_css');
function vlog_customizer_css()
{
    ?>
    <style type="text/css">
 ...
 */
function vlog_customize_preview_js() {
    wp_enqueue_script( 'vlog_customizer', get_template_directory_uri() . '/inc/assets/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'vlog_customize_preview_js' );
